...
class ProductController extends Controller
{
    ...
    public function add_new(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            // 'digital_file_ready'    => 'required_if:product_type,==,digital|required_if:digital_product_type,==,ready_product',
            'digital_file_ready'    => Rule::requiredIf(function () use ($request) {
                if($request->input('product_type') == 'digital' && $request->input('digital_product_type') == 'ready_product')
                    return true;
            }),
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'product_type'          => 'required',
            'digital_product_type'  => 'required_if:product_type,==,digital',
            // 'digital_file_ready'    => 'nullable|required_if:product_type,==,digital|required_if:digital_product_type,==,ready_product',
            'digital_file_ready'    => Rule::requiredIf(function () use ($request) {
                if($request->input('product_type') == 'digital' && $request->input('digital_product_type') == 'ready_product')
                    return true;
            }),
