...
class ChattingController extends Controller
{
    ...
    public function messages_store(Request $request)
    {
        ...
        if ($request->has('shop_id'))
        {
            ...
            $fcm_web_token = $seller->fcm_web_token;
        }
        ...
        if(!empty($fcm_web_token)){
            $arr = [
                'title' => translate('message') . ' - ' . $request->message,
                'body' => $request->message,
            ];
            $data = [
                'type' => 'info'
            ];
            \App\Helpers\General::sendWebNotification($arr, $data, [$fcm_web_token]);
        }
        ...
        //     'type' => 'info'
        // ];
        // return \App\Helpers\General::sendWebNotification($arr, $data, $fcm_token);
