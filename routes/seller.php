...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
            ...
            Route::get('add', 'ProductController@add_new1')->name('add');
            Route::post('add', 'ProductController@store1');
            Route::post('status-update', 'ProductController@status_update')->name('status-update');
            Route::get('list', 'ProductController@list')->name('list');
            Route::get('affiliate', 'ProductController@list1')->name('affiliate');
            Route::get('add', 'ProductController@add')->name('add');
            Route::post('add1', 'ProductController@add1')->name('add1');
            // Route::get('affiliate', 'ProductController@affiliate')->name('affiliate');
    ...
    // Route::get('/fcm-token', [DashboardController::class, 'updateFcmToken']);// for testing
    Route::get('/sendnotification',[DashboardController::class,'notification']); // for testing
    Route::patch('/fcm-web-token', [DashboardController::class, 'updateFcmToken']);
    Route::post('/send-notification',[DashboardController::class,'notification']);
});
