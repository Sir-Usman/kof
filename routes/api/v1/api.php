...
use App\Http\Controllers\api\v3\DirectSellCategoryController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
|
 */
Route::get('directsell_categories', [DirectSellCategoryController::class,'index']);
Route::get('directsell_categories/{id}', [DirectSellCategoryController::class, 'show']);
Route::get('sub-categories/{id}', [DirectSellCategoryController::class, 'sub']);
Route::get('product-details', [DirectSellCategoryController::class, 'form']);
Route::post('product-details', [DirectSellCategoryController::class, 'store']);
