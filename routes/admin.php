...
use App\Http\Controllers\Admin\CryptoAffiliateController;
use App\Http\Controllers\Admin\DirectSellController;
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('forgot-password', 'ForgotPasswordController@sendForgotPassword')->name('send-forgot-password');

        // Reset Password Routes
        Route::get('reset-password/{token}', 'ForgotPasswordController@showResetForm')->name('password.reset');
        Route::post('reset-password', 'ForgotPasswordController@reset')->name('reset-password-submit');
    });
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.', 'middleware' => ['module:user_section']], function () {
            ...
            Route::post('update-seller', 'SellerController@updateSellerRecord')->name('edit-seller-record');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('crypto-affiliate/view', [CryptoAffiliateController::class, 'index'])->name('crypto-affiliate.view');
        Route::post('crypto-affiliate/store', [CryptoAffiliateController::class, 'store'])->name('crypto-affiliate.store');
        Route::get('crypto-affiliate/edit/{id}', [CryptoAffiliateController::class, 'edit'])->name('crypto-affiliate.edit');
        Route::put('crypto-affiliate/update/{id}', [CryptoAffiliateController::class, 'update'])->name('crypto-affiliate.update');
        Route::post('crypto-affiliate/delete', [CryptoAffiliateController::class, 'delete'])->name('crypto-affiliate.delete');

        // Direct sell routes
        Route::get('/direct-sell/list', [DirectSellController::class, 'index'])->name('direct-sell.list');
        Route::get('direct-sell/{product}/edit', [DirectSellController::class, 'edit'])->name('direct-sell.edit');
        Route::get('direct-sell/category', [DirectSellController::class, 'category'])->name('direct-sell.category');
        Route::post('direct_sell/store', [DirectSellController::class, 'storecate'])->name('direct-sell.store');
        Route::get('direct-sell/showcate', [DirectSellController::class, 'showcate'])->name('direct-sell.showcate');
        Route::get('direct-sell/editcate/{id}', [DirectSellController::class, 'editcate'])->name('direct-sell.editcate');
        Route::post('direct-sell/updatecate/{id}', [DirectSellController::class, 'updatecate'])->name('direct-sell.updatecate');
        Route::delete('direct-sell/deletecate/{id}', [DirectSellController::class, 'deletecate'])->name('direct-sell.deletecate');
    });
});
