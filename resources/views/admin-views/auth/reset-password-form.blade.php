...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CPU\translate('Admin | Reset Password')}}</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                        <form id="form-id" action="{{route('admin.auth.reset-password-submit')}}" method="post">
                            @csrf

                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">Reset Password</h1><br>
                                    <span>({{\App\CPU\translate('Admin or Employee Reset Password')}})</span>
                                </div>
                            </div>
