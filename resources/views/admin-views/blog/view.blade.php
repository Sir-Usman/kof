                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.blog.store')}}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                            ...
                            <label class="title-color" for="title">Blog Title<span class="text-danger">*</span></label>
                            <input type="text" name="title" class="form-control" id="title"
                                placeholder="Enter Blog Title" required><br>

                            <label class="title-color" for="image">Blog Image<span class="text-danger">*</span></label>
                            <input type="file" name="image" class="form-control" id="image"
                                accept="image/*" required><br>

                            <label class="title-color" >Blog Description<span class="text-danger">*</span></label>
                            ...
                            @foreach($blogs as $key=>$blog)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{$blog['image']}}" alt="blog_image" class="img rounded-circle"
