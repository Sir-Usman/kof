            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row flex-between align-items-center g-2 mb-3">
                        <form class="row col-12" id="order_stats_update_form">
                            ...
                            <div class="col-md-4 form-group">
                                <button type="submit" class="btn w-100 mt-4 btn-primary">Submit</button>
                            </div>
                        </form>
                        <div class="col-sm-6">
...
@push('script_2')
    ...
    <script>
        $("#order_stats_update_form").submit(function(e){
            e.preventDefault();
            $.ajaxSetup({
                headers: {
            ...
            $.post({
                ...
                data: $("#order_stats_update_form").serialize(),
                beforeSend: function () {
                    $('#loading').show()
                },
