                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-5 mb-lg-0">
                                    <div class="form-group">
                                        ...
                                        <label for="title" class="title-color text-capitalize">Blog Title</label>
                                        <input type="text" name="title" class="form-control" value="{{$crypto_affiliate['title']}}" required>
                                    </div>


                                    <div class="form-group">
                                        <label for="title" class="title-color text-capitalize">Blog Description</label>
                                        <textarea name="description" class="form-control" required id="editor">
                                            {{$crypto_affiliate['description']}}"
                                        </textarea>
                                    </div>
