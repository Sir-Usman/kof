...
<head>
    ...
    <title>{{\App\CPU\translate('Forget your Password?')}} | {{ config('app.name') }}</title>
    ...
    <style type="text/css">
        ...
        .ReadMsgBody {width:100%; background-color: {{ config('pleb.mail.color') }};}
        /* iOS BLUE LINKS */
    ...
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#f0f0f0" data-composer>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                <!-- lotus-header-4 -->
                <tr>
                    <td align="center"  bgcolor="{{ config('pleb.mail.background_color') }}" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td align="center" class="container-padding">
                                                ...
                                                <!-- column -->
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="width:100%;max-width:280px;">
                                                    <tr  >
                                                        <td align="center" class="center-text">
                                                            <a href="{{ url('/') }}"><img style="height: 40px!important; width:auto;border:0px;display: inline!important;" src="{{ config('pleb.mail.top_logo') }}" width="180" height="40" border="0"  alt="{{ config('app.name') }}"></a>                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:{{ config('pleb.mail.color') }};text-decoration:none;letter-spacing:0px;">

                                    <div  >
                                        {{\App\CPU\translate('Forget Your password?')}}
                                    </div>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:{{ config('pleb.mail.color') }};text-decoration:none;letter-spacing:0px;">

                                    <div>
                                        {{\App\CPU\translate('We received a request to reset your password. Visit the following link to reset your password.')}}
                                    </div>
                            ...
                            <tr  >
                                <td align="center">
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center" bgcolor="{{ config('pleb.mail.button_background_color') }}" style="border-radius: 6px;">
                                                <!--[if (gte mso 9)|(IE)]>
                                                ...
                                                <a href="{{$url}}" target="_blank" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:{{ config('pleb.mail.button_color') }};text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{\App\CPU\translate('Click to Reset')}}</span></a>
                            ...
                            <tr>
                                <td align="left">
                                    <div>
                                        <a href="" style="color:{{ config('pleb.mail.color') }}"></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="center">
                                                                                @if($item->name == 'facebook')
                                                                                    <a href="{{$item->link}}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('public/assets/front-end/png/Facebook.png') }}" width="36" border="0" alt="icon"></a>
                                                                                @elseif($item->name == 'instagram')
                                                                                    <a href="{{$item->link}}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('public/assets/front-end/png/Instagram.png') }}" width="36" border="0" alt="icon"></a>
                                                                                @else
                                                        ...
                                                        {{-- <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.facebook_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('public/assets/front-end/png/Facebook.png') }}" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('public/assets/front-end/png/Instagram.png') }}" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('public/assets/front-end/png/Twitter.png') }}" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.pinterest_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('public/assets/front-end/png/Pinterest.png') }}" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr  >
                                                        <td align="center">
                                                            <a href="{{config('pleb.mail.ios_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="{{ asset('public/assets/front-end/png/App-Store.png') }}" border="0"  alt="icon"></a>
                                                        </td>
                                                        <td width="10" style="width: 10px;"></td>
                                                        <td align="center">
                                                            <a href="{{config('pleb.mail.play_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="{{ asset('public/assets/front-end/png/Google-play.png') }}" border="0"  alt="icon"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
