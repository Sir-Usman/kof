...
@section('title',\App\CPU\translate('Affiliate'))
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                <a href="{{route('seller.product.add-new')}}" class="btn btn--primary">
                                    <i class="tio-add"></i>
                                    <span class="text">{{\App\CPU\translate('Add new Affilate')}}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="datatable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            <tbody>
                            @foreach($affiliate as $k=>$p)
                                <tr>
                                    <th scope="row">{{$affiliate->firstitem()+ $k}}</th>
                                    <td>
