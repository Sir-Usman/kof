                ...
                <form class="product-form" action="{{route('seller.product.update',$product->id)}}" method="post"
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4 class="mb-0">{{ \App\CPU\translate('Is External Link?') }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="title-color"
                                            for="">{{ \App\CPU\translate('external_link_btn_text') }}
                                            </label>
                                        <input type="text" name="external_link_btn"
                                            class="form-control" value="{{ old('external_link_btn', $product['external_link_btn']) }}"
                                            placeholder="{{ \App\CPU\translate('external_link_btn') }}" />
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="title-color"
                                            for="">{{ \App\CPU\translate('external_link') }}
                                            </label>
                                        <input type="text" name="external_link"
                                            class="form-control" value="{{ old('external_link', $product['external_link']) }}"
                                            placeholder="{{ \App\CPU\translate('external_link') }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label for="name" class="title-color">{{ \App\CPU\translate('Category')}} <span class="text-danger">*</span></label>
                                        <select
                                    ...
                                    @if($brand_setting)
                                    <div class="col-md-4 mb-3">
                                        <label for="name" class="title-color">{{\App\CPU\translate('Brand')}} <span class="text-danger">*</span></label>
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="brand_id">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-2 d-flex flex-wrap gap-1 align-items-baseline">
                                        ...
                                        <small class="text-danger">* ( {{\App\CPU\translate('ratio')}} 1:1 )</small>
                                    </div>
