                ...
                <form class="product-form" action="{{ route('seller.product.add-new') }}" method="post"
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4 class="mb-0">{{ \App\CPU\translate('Is Affliate Link?') }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="external_link_btn"
                                            class="form-control" value="{{ old('external_link_btn', 'Buy Outside KF') }}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="external_link"
                                            class="form-control" value="{{ old('external_link') }}"
