                    ...
                    <div class="p-5">
                        ...
                        <form class="user" action="{{route('shop.apply')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6"><small class="text-danger">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('like_for_PK_+92')}} )</small>
                            ...
                            <div class="row">
                                ...
                                <div class="pb-1">
                                    <center>
                                        <img style="width: auto;border: 1px solid; border-radius: 10px; max-height:200px;" id="viewer"
                                            src="{{asset('public\assets\back-end\img\400x400\img2.jpg')}}" alt="Id Card image"/>
                                    </center>
                                </div>

                                <div class="form-group">
                                    <div class="custom-file" style="text-align: left">
                                        <input type="file" name="Id1" id="customFileUpload" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="customFileUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('CNIC/ID Just Front Side')}}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-md-3 mb-3 mb-sm-0 ">
                                    <select class="form-control" name="city_id" id="city_id" required>
                                        <option value="">Please selet city</option>
                            ...
                            <button type="submit" class="btn btn--primary btn-user" id="apply" disabled>{{\App\CPU\translate('Apply')}} {{\App\CPU\translate('Shop')}} </button>
                            <br>
                        </form>
                                                <br>
