                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 mb-3">
                                    <div class="text-info mb-2">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('like_for_Pak_+92')}} )</div>
                                  
                                    <input type="number" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           placeholder="+92(301)173-50-10" aria-label="+92(301)173-50-10"
                                           value="{{$data->phone}}"
                                           data-hs-mask-options='{
                                           "template": "+92(301)173-50-10"
                                         }' required>
                                </div>
                            </div>
                            <!-- End Form Group -->
