     <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4633950760789412"
     crossorigin="anonymous"></script>
     <!--google.com, pub-4633950760789412, DIRECT, f08c47fec0942fa0-->
     <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-BE6HRGBL51"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-BE6HRGBL51');
</script>
     <!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-TBMWCV7H');</script>
<!-- End Google Tag Manager -->
<script>
    ;(function() {
        var script = document.createElement('script');
        script.id = '45ff2b9b-91df-423c-ab71-6e803de86a2d';
        script.type = 'module';
...
<head>
	<meta name="description" content="Khareedo Farokht is an e-commerce multi Vendor Site.Khareedo Farokht is the ultimate destination for online seller! First Time ever no commission on selling.">
</head>
<style>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TBMWCV7H"
            ...
            <div class="container ">
                ...
                <div class="input-group-overlay d-none d-md-block mx-4"
                    ...
                    <form action="{{route('products')}}" type="submit" class="search_form">
                        ...
                        <input type="hidden" id="h_minPrice" name="minPrice" value="">
                        <input type="hidden" id="h_maxPrice" name="maxPrice" value="">

                        <input type="hidden" id="h_freeDelivery" name="freeDelivery" value="">

                        <input type="hidden" id="h_returnAccepted" name="returnAccpeted" value="">

                        <input type="hidden" id="h_cod" name="cod" value="">
                        <input type="hidden" id="h_saalsi" name="saalsiPayment" value="">
                        <input type="hidden" id="h_city_id" name="city_id" value="">

                        <!--hidden filter fields       -->

                        <span class="input-group-append-overlay" style="margin-right:60px; " onclick="openFilter()">
                                
                                    <i class="fa fa-light fa-filter fa-2x fa-border-none" style="color:#b38a11"></i>
                    ...
                    <div class="navbar-tool dropdown {{Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'}}">
                        <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="{{route('wishlists')}}">
                            <span class="navbar-tool-label">
                                ...
                                <i class="navbar-tool-icon czi-heart" style="color:#b38a11;"></i>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                {{-- <a class="dropdown-item"
                                   href="{{route('selling-details')}}"> {{ \App\CPU\translate('Selling History')}} </a> --}}
                                <a class="dropdown-item"
            ...
            <div class="container" style="padding-left: 10px;padding-right: 10px;">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                            ...
                            <!-- Blog -->
                            <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                                <a class="nav-link" href="{{route('all_blogs')}}">
                                    {{\App\CPU\translate('Blogs')}}</a>      
                            </li>

                    {{-- direct selling --}}
                            <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                                <a class="nav-link" href="{{route('sell-now')}}">Sell Now</a>      
                            </li> 
                        
                        <!-- Crypto  -->
                        <!--<li class="nav-item dropdown {{request()->is('/crypto')?'active':''}}">-->
                        <!--    <a class="nav-link text-capitalize" href="{{route('crypto-affiliates')}}">Crypto</a>-->
                        <!--</li>-->
...
<!--//Searching Filter Modal-->
<!-- Modal -->
<div class="modal " id="searchFilterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border: 2px solid #b38a11">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="color:#b38a11">Select your filter</h5>
        ...
        <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="number" value="" name="filterMinPrice" id="filterMinPrice" style="height:30px">
                    </div>
                    <div class="col-sm-2">
                        <label>Max Price</label>
                    </div>
                    <div class="col-sm-4">
                        <input class="form-control" type="number" value="" name="filterMaxPrice" id="filterMaxPrice" style="height:30px">
                    </div>
                </div>
                <br>
                <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="checkbox" @if(request()->freeDelivery == 'true') checked @endif data-toggle="toggle" data-size="lg" id="filterFreeDelivery">
                </div>
                <div class="col-sm-6">
                    <label>Return Accepted </label>
                    <input type="checkbox" @if(request()->returnAccpeted == 'true') checked @endif data-toggle="toggle" data-size="lg" id="filterReturnAccepted">
                </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-sm-6">
                        <label>Saalsi Payment </label>
                        <input type="checkbox" @if(request()->saalsiPayment == 'true') checked @endif data-toggle="toggle" data-size="lg" id="filterSaalsiPayment">
                    </div>
                    <div class="col-sm-6">
                        <label>Cash On Delivery </label>
                        <input type="checkbox" @if(request()->cod == 'true') checked @endif data-toggle="toggle" data-size="lg" value="" id="filterCOD">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        ?>
                        <select class="form-control" name="city_id" id="filterCityId">
        ...
        <div class="modal-footer">
            <button type="button" class="btn" onclick="saveFilter()" style="background-color:#b38a11;color:white;">Save changes</button>
        </div>
    </div>
  </div>
</div>
...
function saveFilter(){
    ...
    var filterCOD = $('#filterCOD').prop('checked');
    var filterSaalsiPayment = $('#filterSaalsiPayment').prop('checked');
    var filterReturnAccepted = $('#filterReturnAccepted').prop('checked');
    var filterFreeDelivery = $('#filterFreeDelivery').prop('checked');
    var filterMaxPrice = $('#filterMaxPrice').val();
    var filterMinPrice = $('#filterMinPrice').val();
    var filterCityId = $('#filterCityId').val();


        $('#h_cod').val(filterCOD)
        $('#h_saalsi').val(filterSaalsiPayment)
        $('#h_freeDelivery').val(filterFreeDelivery)
        $('#h_returnAccepted').val(filterReturnAccepted)
        $('#h_minPrice').val(filterMinPrice)
        $('#h_maxPrice').val(filterMaxPrice)
        $('#h_city_id').val(filterCityId)
