...
<footer class="page-footer font-small mdb-colorrtl">
    <!-- Footer Links -->
    <div style="padding-top:30px;"> {{-- background:{{$web_config['primary_color']}}20 --}}
        <div class="container text-center" style="padding-bottom: 13px;">
            ...
            <div
                ...
                <div class="col-md-3 d-flex- justify-content-start align-items-center footer-web-logo" >
                    <a class="d-block mt-n1" href="{{route('home')}}">
                    ...
                    <div class="mt-4">
                        Khareed O Farokht is an online buying & selling platform where you can buy any product and communicate with seller.
                    </div>
                </div>
                <div class="col-md-9" >
                    <div class="row">
    ...
    <!-- Grid row -->
    <div style="background:#000000"> {{--background: {{$web_config['primary_color']}}10;--}}
        <div class="container">
            <div class="row end-footer footer-end last-footer-content-align">
                ...
                <div class="mt-md-1 mt-0 mb-md-1 {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
