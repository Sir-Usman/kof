...
<head>
    ...
    <script>
        ...
        var firebaseConfig = {
            ...
            authDomain: "khareedo-farokht-buyer.firebaseapp.com",
            databaseURL: "https://khareedo-farokht-buyer-default-rtdb.firebaseio.com",
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4559555117914961"
    ...
    <style>
        ...
        .rounded-lg2{border-radius:20px !important}
        .shadow2{}
    ...
    @endif
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-QB8G1CPTXS"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-QB8G1CPTXS');
    </script>
</head>
<!-- Body-->
...
<script>
    ...
    messaging.onMessage(function(payload){
        ...
        toastr[payload.data.type](payload.notification.title);
    });
</script>
<script>
...
<script>
    ...
    jQuery(".search-bar-input").keyup(function () {
        ...
        // filter Items
        let minPrice = $("#h_minPrice").val();
        let maxPrice = $("#h_maxPrice").val();
        let freeDelivery = $("#h_freeDelivery").val();
        console.log(freeDelivery)
        let returnAccepted = $("#h_returnAccepted").val();
        let cod = $("#h_cod").val();
        let saalsiPayment = $("#h_saalsi").val();
