                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/product*'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                             ...
                             {{--   <li class="nav-item {{Request::is('seller/product/affiliate') || Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.affiliate')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Affiliate')}}</span>
                                    </a>
                                </li> --}}
