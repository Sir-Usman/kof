                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        {{-- Direct selling --}}
                         <li class="navbar-vertical-aside-has-menu">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               title="{{\App\CPU\translate('Direct-sell')}}"
                               href="{{url('admin/direct-sell/list')}}">
                                <i class="tio-dollar nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{\App\CPU\translate('Direct-sell')}}
                                </span>
                            </a>
                        </li>
                        {{-- end direct selling --}}
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/crypto-affiliate*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{route('admin.crypto-affiliate.view')}}"
                                title="Crypto Affiliate">
                                <i class="tio-category-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Crypto Affiliate</span>
                            </a>
                        </li>
