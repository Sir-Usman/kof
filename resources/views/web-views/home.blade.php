    ...
    <div class="container rtl">
        <div class="row ">
            ...
            <div class="col-xl-3 col-md-4 pb-4 mt-3 pl-0 pr-0">
                <div class="deal_of_the_day shadow2 rounded-lg2" style="background: {{$web_config['primary_color']}};height: 754px;">
                    ...
                    @else
                        ...
                        @if(isset($product))
                            ...
                            <div class="recomanded-product-card">
                                <div class="d-flex justify-content-center align-items-center" style="margin:20px 20px -20px 20px;padding-top: 20px;">
                                    <img style="max-height:220px" src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                                ...
                                <div style="background:#ffffff;margin:20px;padding-top: 10px;border-radius: 0px 0px 5px 5px;">
                                    <div style="text-align: left; padding: 20px;">
                                        ...
                                        <div class="rating-show">
                                            <h5 style="font-weight: 600; color: {{$web_config['primary_color']}}; height:50px; overflow: hidden; text-overflow: ellipsis;">
                            ...
                            <div class="recomanded-buy-button">
                                <button class="buy_btn" style="color:{{$web_config['primary_color']}}" onclick="location.href='{{route('product',$product->slug)}}'">{{\App\CPU\translate('buy_now')}}</button>
                            </div>
                        @endif
                    @endif
                </div>
...
@php($main_section_banner = \App\Model\Banner::where('banner_type','Main Section Banner')->where('published',1)->orderBy('id','desc')->latest()->first())
        ...
        <div class="row" >
            <div class="col-12 pl-0 pr-0">
                <a href="{{$main_section_banner->url}}" style="cursor: pointer;">
                    <img class="d-block footer_banner_img" style="width: 100%;border-radius: 5px; height: 200px;" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" src="{{asset('storage/app/public/banner')}}/{{$main_section_banner['photo']}}">
                </a>
            </div>
        </div>
    </div>
                                    ...
                                    @if ($key<10)
                                        <div class="text-center col-4 col-md-2 my-3">
                                            <a href="{{ route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1]) }}">
                                                <img style="border-radius: 5px; height: 100px;" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" src="{{asset("storage/app/public/category/$category->icon")}}" alt="{{$category->name}}">
                                                <p class="text-center small mt-3 mb-0">{{Str::limit($category->name, 12)}}</p>
                                            </a>
                                        </div>
                                    @endif
                                @endforeach
        ...
        {{-- @if ($business_mode == 'multi')
            @if(count($top_sellers) > 0)
                <div class="col-md-6 mt-2 mt-md-0 seller-card " >
                    <div class="card shadow2 rounded-lg2" style="min-height: 383px;">
                        <div class="card-body">
                            <div class="row d-flex justify-content-between">
    ...
    {{-- Categorized product + remove products count when every category have product --}}
                ...
                <div style="background: #ffffff; padding:20px;border-radius:5px;" class="shadow2 rounded-lg2">
                    ...
                    <div class="row mt-2 mb-3 d-flex justify-content-between">
                        <div class="col-md-3 col-12 pl-3 pr-3">
                            <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}"
                                style="cursor: pointer;">
                                <img class="" style="width: 100%; border-radius:5px;height: 190px;"
                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    src="{{asset('storage/app/public/category')}}/{{$category['icon']}}">
                            </a>
                        </div>
