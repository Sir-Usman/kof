...
<div class="product-single-hover" >
    <div class=" inline_product clickable d-flex justify-content-center" style="cursor: pointer;background:{{$web_config['primary_color']}}10;">
        ...
        @endif
        <div class="d-flex d-block pointer" style="height:200px">
            <a href="{{route('product',$product->slug)}}">
                <img src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                    style="width: 100%;border-radius: 5px 5px 0px 0px; height:200px">
            </a>
        </div>
    </div>
    <div class="single-product-details" style="position:relative;padding-top:10px;border-radius: 0px 0px 5px 5px; height:145px !important; ">
        <div class="text-{{Session::get('direction') === "rtl" ? 'right pr-3' : 'left pl-3'}}" style="height:55px !important;">
            <a href="{{route('product',$product->slug)}}">
