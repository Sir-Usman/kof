...
<div class="product-single-hover" style="">
    <div class=" inline_product clickable d-flex justify-content-center"
        ...
        @endif
        <div class="d-flex d-block" style="cursor: pointer; height:200px">
    ...
    <div class="single-product-details" style="position:relative;height:145px !important;padding-top:10px;border-radius:0px 0px 5px 5px; ">
