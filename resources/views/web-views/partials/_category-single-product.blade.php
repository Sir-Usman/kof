...
<div class="product-single-hover" >
    <div class=" inline_product clickable d-flex justify-content-center"
        ...
        @endif
        <div class="d-flex d-block pointer" style="height:155px">
            <a href="{{route('product',$product->slug)}}">
                <img src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                    style="width: 100%;border-radius: 5px 5px 0px 0px; height:155px">
            </a>
        </div>
    </div>
    <div class="single-product-details" style="position:relative;padding-top:10px;border-radius: 0px 0px 5px 5px; height:145px !important; ">
        <div class="text-center" style="height:55px !important;">
            <a href="{{route('product',$product->slug)}}" style="font-weight: 400; font-size: 13px; ">
                {{ Str::limit($product['name'], 18) }}
            </a>
        </div>
        <div class="rating-show justify-content-between text-center">
            <span class="d-inline-block font-size-sm text-body" style="font-weight: 400; font-size: 10px;">
                @for($inc=0;$inc<5;$inc++)
